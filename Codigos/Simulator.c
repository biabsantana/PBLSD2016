...
int callControlUnit()
{
	...
	if(opcode == 0){
		...
		switch(function){
			//COLOCAR EM CADA CASE DESSE UMA CHAMADA DE UMA FUNÇÃO QUE IRÁ REPRESENTAR A INSTRUÇÃO DO TIPO R
			case 1:
	...
	//I instruction
		...
		//Calls the specific instruction with your parameters
		switch(opcode){
			//COLOCAR EM CADA CASE DESSE UMA CHAMADA DE UMA FUNÇÃO QUE IRÁ REPRESENTAR A INSTRUÇÃO DO TIPO I
			case 1:
	...
	//J instruction
		...
		//Calls the specific instruction with your parameters
		switch(opcode){
			//COLOCAR EM CADA CASE DESSE UMA CHAMADA DE UMA FUNÇÃO QUE IRÁ REPRESENTAR A INSTRUÇÃO DO TIPO J
			case 16:
